(() => {
  ...
  async function us() {
    ...
    if (ae && !n.length)
      return ((F.chatStatus = ae), (F.chatError = ""), void Ki());
    if (!t && !ne && !n.length)
      return (
        (F.chatStatus = "找不到聊天室，請確認直播聊天室已開啟。"),
        (F.chatError = ""),
        void Ki()
      );
    if (!n.length)
      return (
        (F.chatStatus = "等待聊天室留言..."),
        (F.chatError = ""),
        void Ki()
      );
    let a = 0;
    ...
    a &&
      ((F.chatStatus = `已擷取 ${F.chatItems.length} 則留言，翻譯中...`), Ki());
  }
  function ms(e) {
    const t = ku(e.text);
    if (!t) return !1;
  ...
  function ys(e = {}) {
    if (!F.chatPanelOpen || !oe.length || ee) return;
      ...
      try {
        const e = (function (e = []) {
            ...
            return {
              ...
              {
                text: ku(a),
                sourceLang: $i(F.config?.sourceLang || "auto", "auto", {
                  keepAuto: !0,
                }),
